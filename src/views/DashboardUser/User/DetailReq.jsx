...
import "../../../sass/User/User/DetailReq/DetailReq.css";
...
export default function DetailReq() {
  ...
  return (
    <div className="container-detail-user">
      ...
      <div className="button-back-user">
        <button onClick={() => navigate(-1)} className="backButton-user">
          Back
        </button>
      </div>
    </div>
