...
import "../../../sass/Admin/Admin/ReportAdmin/ReportAdmin.css";
...
export default function ReportAdmin() {
  ...
  return (
    <div className="report-container-admin">
      <h2 className="report-title-admin">
        <i>KANBAN REQUEST REPORT</i>
      </h2>

      <div className="form-group-report-admin">
        <label htmlFor="month">
          <strong>
            <i>Month</i>
          </strong>
      ...
      <div className="button-group-report-admin">
        <div className="export-buttons-admin">
          <button
            className="btn pdf-btn-admin"
            onClick={(e) => handleDownload(e, "pdf")}
          >
            <img src={Pdf} alt="" /> Export PDF
          </button>
          <button
            className="btn excel-btn-admin"
